# magicdata asr recipe

This egs3 data module reads the Kaldi `wav.scp` and `text` files produced by
the corresponding egs2 recipe: `egs2/magicdata/asr1/local/data.sh`.

Set `MAGICDATA` to the downloaded corpus location when using the egs2 data
